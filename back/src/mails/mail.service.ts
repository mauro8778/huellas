...
export class MailService {
  ...
  https://huellas-eight.vercel.app/login
  ...
  <div style="border: 2px solid #ff3366; padding: 20px; background: white; border-radius: 15px; text-align: center; max-width: 600px; margin: 0 auto;">
    ...
    <p>Para iniciar sesión con tu nueva contraseña, sigue el enlace a continuación:</p>
    <p>
      <a href="https://huellas-eight.vercel.app/login" style="display: inline-block; padding: 10px 20px; background: linear-gradient(to bottom, #ff3366, #ff3366); color: white; text-decoration: none; border-radius: 5px; box-shadow: 0 5px 15px rgba(255, 0, 102, 0.3); transition: all 0.3s ease;">
        Iniciar Sesión
      </a>
    </p>
    <p>Si tienes alguna pregunta o necesitas ayuda, no dudes en contactarnos.</p>
